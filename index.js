...
const RiddleIntentHandler = {
    ...
    handle(handlerInput) {
        const dayNumber = dayOfTheYear();//getting the daynumber
...
const AnswerIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        const userAnswer = handlerInput.requestEnvelope.request.intent.slots.answer.resolutions.resolutionsPerAuthority[0].values[0].value.name;//useranswer
